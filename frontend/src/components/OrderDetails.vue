  ...
  <q-dialog v-model="dialog">
    <q-card id="window">
      ...
      <div class="row full-width" style="margin: 10px 0 10px 0">
        ...
        <div class="col text-h5 text-center text-bold">Order #{{ order.id }}</div>
        <div class="col text-h6 text-right">State: {{ order.state }}</div>
      </div>
      <q-card-section class="items-center q-pb-none">
        <q-scroll-area class="q-gutter-y-md" style="height: 300px" visible>
      ...
      <q-card-section class="items-center">
        <div class="text-h5 text-center text-bold">Total: {{ totalcost }} zł/mo</div>
      </q-card-section>
    </q-card>
  </q-dialog>
</template>
